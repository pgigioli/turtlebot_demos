...
void callback(const geometry_msgs::Point::ConstPtr& msg)
{
  ...
  {
	string command = "uvcdynctrl -s \"Tilt (relative)\" -- -" + moveIncr;
  ...
  {
	string command = "uvcdynctrl -s \"Pan (relative)\" -- " + moveIncr;
        system(command.c_str());
  }
  ...
  {
	string command1 = "uvcdynctrl -s \"Tilt (relative)\" -- -" + moveIncr;
	string command2 = "uvcdynctrl -s \"Pan (relative)\" -- " + moveIncr;
