...
int main(int argc, char **argv)
{
	...
	while(ros::ok())
	{
		...
		else
		{
			...
			//modelstate.pose.position.x = index->second.get_element(0);
			//modelstate.pose.position.y = index->second.get_element(1);
			//modelstate.pose.orientation.z = index->second.get_element(2);
